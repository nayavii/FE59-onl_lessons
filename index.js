...
//     // const letters = [];
//     // let result = false; // здесь будет результат true/false
...
//     letters['qwdmqwkfhqwhfbewfbewfewfuhew'] // undefinde

//     const result = word.toLowerCase().split('').every((item, index, array) => {
//         // if (letters[item]) {
//         //     return false;
//         // } else {
//         //     letters[item] = true;
...
//         // вспомнить все!
//         // return letters[item] ? false : true;
//         // return !!letters[item];
//     });
...
// console.log(isIsogram('maMa')); // false
// console.log(isIsogram('Bill')); // false
// console.log(isIsogram('Yes')); // true
// console.log(isIsogram('no')); // true
...
// console.log(typeof typeof 1); // typeof 'number'
...
// d = {...c}; // dth[ytehjdytdjt rjgbhjdfybt]
// c.greeting = "Hello";
...
// const meFriend = shelf;

// meFriend.meThing = 'banana';

// shelf // {meThing: 'banana'},
...
// ((name) => {console.log(name)})('ivane')



// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// !!!!!!!!!!!!!!!!!!!!!!СТРАШНЫЕ ВОПРОСЫ И НЕ МЕНЕЕ СТРАШНЫЕ ОТВЕТЫ!!!!!!!!!!!!!!!!!!!!!!
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
//   },
//   perimeter: () => 2 * Math.PI * this.radius, // this.radius ===
// };
...
//   "[object Object]": 456,
// };
// const b = { key: "b" }; // String({ key: "b" }) === "[object Object]"
// const c = { key: "c" };
